...
{
    [Info("GUI Shop", "Nogrod / Reneb / Xianith", "1.4.6.1", ResourceId = 1319)]
    ...
    public class GUIShop : RustPlugin
    {
        ...
        private const string ShopingCart = "ShopingCart";
        ...
        string MessageErrorNotEnoughMoney = "You need {0} cash to buy {1} of {2}";
            ...
            {
                {
                    "chat", new Dictionary<string, object>
                    {
                        ...
                        {"description", "You currently have {0} cash to spend in this builders shop"},
                        {"name", "Build"}
                    }
                },
                {
                    ...
                    {
                        {"description", "You currently have {0} cash to spend in this weapons shop"},
                ...
                },
                {
                    ...
                    {
                        {"description", "You currently have {0} cash to spend in this farmers market"},
                        {"name", "Fruit Market"},
            ...
            return new CuiElementContainer
            {
                ...
                },
                {
                    new CuiButton
                    {
                        ...
                        RectTransform = {AnchorMin = "0.44 0.14", AnchorMax = "0.546 0.17"},
        ...
        public CuiLabel shopAction = new CuiLabel
        {
            Text = {Text = "", FontSize = 15, Align = TextAnchor.MiddleLeft},
            RectTransform = {AnchorMin = "0.345 0.10", AnchorMax = "0.60 0.14"}
        };
        ...
        private CuiElementContainer CreateShopItemEntry(string price, float ymax, float ymin, string shop, string item, string color, bool sell, bool cooldown)
        {
            ...
            for (var i = 0; i < steps.Length; i++)
            {
                container.Add(new CuiButton
                {
                    ...
                    RectTransform = {AnchorMin = $"{(sell ? 0.775 : 0.5) + i*0.03 + 0.0011} {ymin}", AnchorMax = $"{(sell ? 0.805 : 0.53) + i*0.03 - 0.001} {ymax}"},
            ...
            {
                {
                    new CuiButton
                    {
                        ...
                        RectTransform = {AnchorMin = "0.345 0.14", AnchorMax = "0.438 0.17"},
                ...
                },
                {
                    new CuiButton
                    {
                        ...
                        RectTransform = {AnchorMin = "0.548 0.14", AnchorMax = "0.64 0.17"},
                        Text = {Text = ">>", FontSize = 20, Align = TextAnchor.MiddleCenter}
                    },
                    ShopOverlayName,
                    "ButtonForward"
        ...
        private void ShowShop(BasePlayer player, string shopid, int from = 0, bool fullPaint = true, bool refreshMoney = false)
        {
            ...
            if (refreshMoney)
            {
                ...
                // CuiHelper.DestroyUi(player, ShopingCart);
                CuiHelper.AddUi(player, new CuiElementContainer { { shopDescription, ShopOverlayName, ShopDescOverlay } });
                // CuiHelper.AddUi(player, new CuiElementContainer { { shopAction, ShopOverlayName, ShopingCart } });
                return;
            }
            ...
            if (fullPaint)
            {
                ...
                // container.Add(shopAction, ShopOverlayName, ShopingCart);
            }
            else
        ...
        private void ccmdShopShow(ConsoleSystem.Arg arg)
        {
            ...
            Effect.server.Run("assets/prefabs/misc/xmas/presents/effects/unwrap.prefab", player.transform.position, Vector3.zero, null, false);
        ...
        private void ccmdShopBuy(ConsoleSystem.Arg arg)
        {
            ...
            if(success is string)
            {
                shopAction.Text.Text = (string)success;
                CuiHelper.DestroyUi(player, ShopingCart);
                                Effect.server.Run("assets/prefabs/locks/keypad/effects/lock.code.lock.prefab", player.transform.position, Vector3.zero, null, false);
                CuiHelper.AddUi(player, new CuiElementContainer { { shopAction, ShopOverlayName, ShopingCart } });
                return;
            } else { shopAction.Text.Text = string.Format(MessageBought, amount, item);                 Effect.server.Run("assets/prefabs/locks/keypad/effects/lock.code.unlock.prefab", player.transform.position, Vector3.zero, null, false);}
            CuiHelper.DestroyUi(player, ShopingCart);
        ...
        private void ccmdShopSell(ConsoleSystem.Arg arg)
        {
            ...
            if(success is string)
            {
                ...
                CuiHelper.AddUi(player, new CuiElementContainer { { shopAction, ShopOverlayName, ShopingCart } });
                return;
            } else { shopAction.Text.Text = string.Format(MessageSold, amount, item); Effect.server.Run("assets/prefabs/locks/keypad/effects/lock.code.unlock.prefab", player.transform.position, Vector3.zero, null, false);}
            CuiHelper.DestroyUi(player, ShopingCart);
            CuiHelper.AddUi(player, new CuiElementContainer { { shopAction, ShopOverlayName, ShopingCart } });
